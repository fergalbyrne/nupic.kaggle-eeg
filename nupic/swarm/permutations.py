...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'mad': PermuteEncoder(maxval=500.0, fieldName='mad', w=21, clipInput=True, minval=-500.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=500.0, classifierOnly=True, clipInput=True, minval=-500.0, n=PermuteInt(28, 521), fieldname='mad', w=21, type='ScalarEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[5\]:window=1000:field=mad")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[5\]:window=1000:field=mad"
