...
control = {
  ...
  #
  'dataset' : {   u'info': u'mad',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Rec Center',
                            u'source': u'file://mad.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'mad',
 u'predictionSteps': [5]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'mad', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [5], 'errorMetric': 'aae'}),
    MetricSpec(field=u'mad', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [5], 'errorMetric': 'altMAPE'})
  ],
